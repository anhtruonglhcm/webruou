...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('dang-ky', 'Frontend\ContactController@dangky')->name('dangky');
    ...
    Route::group(['prefix' => 'san-pham'], function () {
        ...
        Route::get('/tim-kiem', 'Frontend\ProductController@postSearch')->name('postSearch');
        Route::get('/{slug}', 'Frontend\ProductController@productByCate')->name('productByCate');
        Route::get('/chi-tiet/{slug}', 'Frontend\ProductController@detailProduct')->name('detail_product');
        // Route::get('/chi-tiet', 'Frontend\ProductController@detailProduct2')->name('detail_product2');
    });
    Route::group(['prefix' => 'bai-viet'], function () {
        Route::get('/{slug}', 'Frontend\PostController@postByCate')->name('postByCate');
        // Route::get('/blog', 'Frontend\PostController@blog')->name('blog');
        // Route::get('/list', 'Frontend\PostController@listPost')->name('list_post');
    ...
    Route::group(['prefix' => 'cart'], function () {
        ...
        Route::post('/', 'Frontend\CartController@postOrder2')->name('postOrder2');
        Route::post('/mua-ngay', 'Frontend\CartController@buynow')->name('buynow');
        Route::get('add-cart/{id}', 'Frontend\CartController@addCart')->name('add-cart');
        Route::get('delete-cart/{id}', 'Frontend\CartController@deleteCart')->name('delete-cart');
