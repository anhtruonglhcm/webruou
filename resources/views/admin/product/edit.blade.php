                                    ...
                                    <div class="panel-body">
                                        <form role="form" class="form-horizontal" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="cate_product_id">
                                                            @foreach($data as $l)
                                                            <option
                                                                {{$product->cate_product_id == $l->id ? 'selected': ''}}
                                                ...
                                                <!-- <div class="form-group">
                                                    <label class="col-md-3 control-label">Ảnh chi tiết sản phẩm:
                                                    </label>
                                                    <div class="col-md-8">
                                                        @foreach($img_detail as $i)
                                                        <div class="image">
                                                            <img src="{{ asset($i->name) }}"
                                                                style="height: 50px; width: 50px">
                                                            <label><span class="btn btn-danger delImage" id="data-1"
                                                                    data-id="{{ $i->id }}"> X </span></label>
                                                        </div>
                                                        @endforeach
                                                        <a class="btn btn-primary btn-sm addimg"
                                                            style="margin-top: 2px; margin-left: 0">+ Thêm ảnh</a>
                                                    </div>
                                                </div> -->
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">SP hot: </label>
                                                    <label class="switch">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="number" class="form-control"
                                                            ...
                                                            value="{{ $product->position }}" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control" name="title"
                                                            id="editor2" required>{{ $product->title }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control" name="description"
                                                            id="editor1" required>{{ $product->description }}</textarea>
                                                    </div>
                                                </div>
...
$(document).ready(function() {
    $('.addimg').on('click', function() {
        $('#contentimg').append(
            '<label class="col-md-3 control-label"></label><div class="col-md-8"><input type="file" class="form-control" name="img[]"></div>'
        );
    });
